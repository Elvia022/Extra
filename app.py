...
urls=(
    '/(.*)','index')
db = web.database(dbn='mysql',host='o61qijqeuqnj9chh.cbetxkdyhwsb.us-east-1.rds.amazonaws.com',db='suyfihxzb40ml5my',user='a1v76zervmj5ufwt',pw='fbbo4s7fvukr8o0n')
clientes = clientes()
clientes.readCli()
peliculas = peliculas()
peliculas.readPel()
